...
// export function TaxPDFDocument({ income, effectiveIncome, newRegime, oldRegime }: PDFDocumentProps) {
export function TaxPDFDocument() {

    // console.log('PROPS TaxPDFDocument  ', income, effectiveIncome, newRegime, oldRegime);
